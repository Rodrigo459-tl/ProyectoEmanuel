...
INSERT INTO usuarios (estatus_usuario, id_usuario, nombre_usuario, ap_usuario, am_usuario, sexo_usuario, correo_usuario, password_usuario, imagen_usuario, id_rol) VALUES
	(NULL, NULL, 'Admon', 'Admon', NULL, 0, 'admon@mtvawards.com', SHA2("admon123",0), NULL, 128),
	(NULL, NULL, 'Artista', 'Artista', NULL, 0, 'artista@mtvawards.com', SHA2("artista",0), NULL, 85),
	(NULL, NULL, 'Operador', 'Operador', NULL, 0, 'operador@mtvawards.com', SHA2("operador",0), NULL, 8);
